...
def test_successful():
    ...
    with allure.step("Fill form"):
        ...
        browser.element("#userEmail").set_value("dima-xxx@mail.ru")
        browser.element("#genterWrapper").element(by.text("Other")).click()
        browser.element("#userNumber").set_value("1231231230")
        # browser.element("#dateOfBirthInput").click()
        # browser.element(".react-datepicker__month-select").s("April")
        # browser.element(".react-datepicker__year-select").selectOption("1995")
